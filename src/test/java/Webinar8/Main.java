...
public class Main {
    public static void main(String[] args) {
        ...
        persons[5] = new Student("Radek", "Radkowski", 23, 2, 1, "Informatyka");
        persons[6] = new Student("Tomasz", "Tomczyk", 25, 3, 2, "Historia");
        persons[7] = new Student("Paweł", "Kowalski", 23, 2, 2, "Angielski");
        persons[8] = new Teacher("Krzysztof", "Niewypał", 42, 1500, "profesor");
